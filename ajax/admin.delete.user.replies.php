...
$sql_delete = "DELETE FROM replies_table where id='$get_var'";
$run_query = $conn->query($sql_delete);
if($run_query){
   echo "<div class='alert alert-danger'style='width:70%; margin-left:15%;margin-right:15%;'><i class='fa fa-check-circle-o'></i>&nbsp; 
