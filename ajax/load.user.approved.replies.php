...
$conn = new config();
$comment_id = htmlspecialchars($_GET["co_id"]);
$post_id = htmlspecialchars($_GET["po_id"]);
$approved ="approved";
if($comment_id==""){
    ...
    $sql_select = "SELECT * FROM replies_table where comment_id='$comment_id' AND post_id='$post_id' AND approval='$approved' ORDER BY ID DESC LIMIT 4";
